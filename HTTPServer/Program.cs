...
namespace HTTPServer
{
    public class Interaction
    {
        ...
        public string GetPath(string request)
        {
            ...
            if (url == "")
                url = Main_Page;
            return Path.Combine(Server_Directory , url);
        }
        /// <summary>
    ...
    public class Server
    {
        ...
        public string Server_Directory = "C:\\tmp\\HTTPServer\\";
        public string Error_Message = "None";
        public string Main_Page = "nsu.htm";
        ...
        public void Listen()
        {
            while (true)
            {
                var i = new Interaction(Listener.AcceptTcpClient());
                i.Error_Message = Error_Message;
                i.Main_Page = Main_Page;
                i.Server_Directory = Server_Directory;
                i.Start();
            }
        }
        [STAThread]
        static void Main(string[] args)
        {
            ...
            server.Server_Directory = Path.Combine(Environment.CurrentDirectory, "www") ;
            server.Error_Message = "None";
            server.Main_Page = "nsu.htm";
